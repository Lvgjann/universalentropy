...
<div id="menu">
    ...
    <a href="UniversalEntropy/about.html">About me</a>
    <a href="UniversalEntropy/projects.html">My projects</a>
    <a href="UniversalEntropy/contact.html">Contact</a>
</div>
<div id="banner"></div>
    ...
    <div id="page" class="content">
        <div id="content_index">
            <div class="title">
                ...
                <span class="byline">Where am I ?</span></div>
            <p>
                <?php echo TXT_INDEX_TITLE ?>
            </p>
        </div>
    </div>
</div>
...
<div id="portfolio-wrapper">
    <div id="portfolio" class="content">
        <div id="column1">
            ...
            <a href="CosmicVoid/index.html" class="image image-full">
                <img src="../img/background/mbg_cosmic.png" alt=""/></a>
            <a href="CosmicVoid/index.html" class="icon icon-arrow-right button">Read More</a></div>
        <div id="column2">
            <div class="title">
                <h2>Fire Nebula</h2>
            </div>
            <a href="FireNebula/index.html" class="image image-full">
                <img src="../img/background/mbg_fire.jpg" alt=""/></a>
            <a href="FireNebula/index.html" class="icon icon-arrow-right button">Read More</a></div>
        <div id="column3">
            <div class="title">
                <h2>Stardust</h2>
            </div>
            ...
            <a href="Stardust/index.html" class="icon icon-arrow-right button">Read More</a></div>
        <div id="column4">
            <div class="title">
                <h2>Constellation</h2>
            </div>
            ...
            <a href="Constellations/index.html" class="icon icon-arrow-right button">Read More</a>
        </div>
    </div>
</div>
