...
<div id="page">
    <div id="page_content">
        <div class="title">
            <h2>Se mettre au DIY</h2>
            <span class="byline">Une activité accessible pour tous</span></div>
        <p class="general">
            // TODO : Liens divers, Swann Périssé, Ultia, etc.
        </p>
    </div>
    <!-- Sidebar -->
