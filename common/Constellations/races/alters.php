    ...
    <div id="page_content">
        ...
        <div class="tabcontent" id="P2">
            ...
            <p class="general">
                ...
                chez les Derwenn, ce qui est une de leur caractéristiques principale.
            </p>
        </div>
        <div class="tabcontent" id="P3">
            ...
            <p class="general">
                ...
                peuvent prendre une apparence totalement animale ou humaine à volonté. Ils ont aussi des prédisposition
        ...
        <div class="tabcontent" id="P6">
            ...
            <p class="general">
                ...
                crocs, yeux fendus dans un sens ou dans l'autres, écailles plus ou moins présentes et cheveux de
                ...
                prédisposition pour toutes les formes de psychisme, la métamorphose et la créomancie.
            </p>
        </div>
        <div class="tabcontent" id="P7">
            ...
            <p class="general">
                ...
                d'individus en même temps se trouvent sur la planète. Ils sont originaires de Celestùn, et ne viennent
                ...
                cheveux blonds tirant parfois sur les blanc, des yeux clairs, des traits fins et une paire d'ailes dans
        ...
        <div class="tabcontent" id="P8">
            ...
            <p class="general">
                ...
                général la magie psychique, en particulier la possession et les illusions. Ils sont aussi capable de se
        ...
        <div class="tabcontent" id="P13">
            <h2>Naïades</h2>
            <p class="general">
                Femmes plus proche des mammifères marins que des poissons, habitant les eaux douces.
                Pas de queue ni de branchies, mais des pieds très longs et palmés et des cheveux. Elles ont un mode de
                vie presque amphibie même s'ils passent toujours plus de temps dans l'eau que dehors.
        ...
        <div class="tabcontent" id="P14">
            ...
            <p class="general">
                ...
                Parmi les moins réticents à se mêler aux humains et autres alters, mais ils restent très secrets.
        ...
        <div class="tabcontent" id="P19">
            ...
            <p class="general">
                ...
                sont pacifistes de nature. Leur culture est très riche et ancienne, transmise sous formes de chants
                ...
                créés les bases de la créomancie.
            </p>
        </div>
        <div class="tabcontent" id="P20">
            ...
            <p class="general">
                ...
                Mis à part la relation très particulièrement, quasi symbiotique avec leurs Einherjärs et leurs consœurs,
        ...
        <p>
            ...
            dernières sont disparues) sont appelés les "races tierces", ou "Alters extérieures". Les Valkyries sont ou
