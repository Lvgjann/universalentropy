...
<div id="page">
    <div id="page_content">
        ...
        <p>
            La Magie a été pratiquée traditionnellement comme un art ancestral, raffiné pendant des siècles, des
        ...
        <div class="tabcontent" id="P2">
            <p class="general">
                ...
                naissance, on ne peut pas apprendre la Voie peut importe ses efforts.
            ...
            <span class="byline">Branches</span>
            <p>
                Il existe deux branches principales de divination, la clairvoyance et la communion. La
                clairvoyance est la divination au sens classique : précognition, rétrocognition et localisation d'objets
                ou de personnes. La communion comprend tout ce qui touche aux esprits : vision de l'invisible,
                communication avec les esprits et exorcisme. Il est courant de se spécialiser dans une branche tout en
                possédant de solides bases dans l'autre.
            </p>
        </div>
        ...
        <div class="tabcontent" id="P5">
            <p class="general">
                La Divination n'est pas à proprement parler une Voie, mais plutôt un pouvoir : sans avoir le Don à la
                naissance, on ne peut pas apprendre la Voie peut importe ses efforts. <br>
                la divination tend à se manifester spontanément par des visions ou dans les rêves, mais on peut
                apprendre à provoquer et contrôler son don. De plus, il existe des techniques pour l'amplifier,
                notamment par la consommation de certains psychotropes et l'utilisation d'objets particuliers
        ...
        <div class="tabcontent" id="P9">
            <p class="general">
                ...
                maîtriser leur branche au point où ils peuvent annuler les effets de leur magie sur eux-même.
        ...
        <div class="tabcontent" id="P10">
            <p class="general">
                ...
                la nécromancie. <br>
                Comme les Anciens et les Alfren ont disparus avec leurs connaissances, et que la Magie des Valkyries est
        ...
        <div class="tabcontent" id="P13">
            <p class="general">
                ...
                mutants ont eu le pouvoir de maîtriser la gravité sur eux-même et ce qu'ils touchaient, dont une mutante
        ...
        <ul>
            ...
            <li>
                La Chaire : la partie matérielle des êtres vivants (végétaux inclus malgré le nom)
            </li>
            <li>
        ...
        <p>
            ...
            de l'adapter légèrement pour lui-même et d'en tirer le meilleur partie. <br>
