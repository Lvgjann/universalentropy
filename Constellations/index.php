...
<head>
    ...
    <link href="../_style/style_const.css" rel="stylesheet" type="text/css" media="all"/>
...
<div class="main_content">
    <div id="page" class="content">
        <div id="content_index">
            ...
            <p class="general">
                Welcome in my universe. You're in its middle, in the <span style="font-weight: bold;">Cosmic Void</span>.
                you will find here my general presentation, who I am, what I do, etc. To see more about my projects, see
                the different places of my universe below.
            </p>
        </div>
    </div>
</div>
...
<div id="portfolio-wrapper">
    <div id="portfolio" class="content">
        ...
        <div id="column2">
            ...
            <a href="../FireNebula/index.php" class="icon icon-arrow-right button">Read More</a></div>
        <div id="column3">
            <div class="title">
                <h2>Stardust</h2>
            </div>
        ...
        <div id="column4">
            ...
            <a href="index.php" class="image image-full">
                <img src="../_style/images/mbg_const.jpg" alt=""/></a>
            <a href="index.php" class="icon icon-arrow-right button">Read More</a>
        </div>
    </div>
</div>
...
<div id="footer-wrapper">
    <div id="footer" class="content">
        ...
        <div id="box3">
            ...
            <a href="contact.html" class="icon icon-arrow-right button">Read More</a>
        </div>
    </div>
</div>
