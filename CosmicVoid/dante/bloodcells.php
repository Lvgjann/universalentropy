...
<div id="page">
    ...
    <div id="sidebar">
        <div class="box2">
            ...
            <ul class="style2">
                <li><a href="../rpg/game_system.php">Game system</a></li>
                <li><a href="../rpg/trivia.php">Trivia</a></li>
                <li><a href="../rpg/templates.php">Character sheets and templates</a></li>
            </ul>
            <div class="title">
                <h2>Nukes : Blood Cells</h2>
            </div>
            <ul class="style2">
                <li><a href="#">Plot</a></li>
            </ul>
