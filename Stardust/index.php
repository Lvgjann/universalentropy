...
<head>
    ...
    <link href="../_style/style_stardust.css" rel="stylesheet" type="text/css" media="all"/>
    ...
    <div id="page" class="content">
        <div id="content_index">
            ...
            <p>Hi, I am Fi, and you are nowhere, in my nowhere. You will find here some of my projects, in many domains
                such as roleplay, litterature or music. I don't have much to say, so I wish you a nice tour on my
                website</p>
        </div>
    </div>
</div>
...
<div id="portfolio-wrapper">
    <div id="portfolio" class="content">
        ...
        <div id="column4">
            ...
            <a href="../Constellations/index.php" class="icon icon-arrow-right button">Read More</a>
        </div>
    </div>
</div>
